...
# ACDS 12.1 177 win32 2013.03.11.15:47:44
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/first_nios2_system_rsp_xbar_demux_002.sv"                           -work rsp_xbar_demux_002                                                      
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/fp_cust_insn.v"                                                     -work fp_cust_insn_0                                                          
